            ...
            <div className="contact">
                ...
                >
                    <div className="container tm-container-contact">
                        <div className="row">
                            <div className="col-12">
                                <h2 className="mb-4 tm-section-title">
                                    Contact Us
                                </h2>
                                ...
                                <p className="mb-5">
                                    Nullam tincidunt, lacus a suscipit luctus,
                                    elit turpis tincidunt dui, non tempus sem
                                    turpis vitae lorem. Maecenas eget odio in
                                    sapien ultrices viverra vitae vel leo.
                                    Curabitur at elit eu risus pharetra
                                    pellentesque at at velit.
                                </p>
                            </div>
                            <div className="col-sm-12 col-md-6 d-flex align-items-center tm-contact-item">
                                <a
                                    href="tel:1-415-217-9665"
                                    className="tm-contact-item-link"
                                >
                            ...
                            <div className="col-sm-12 col-md-6 d-flex align-items-center tm-contact-item">
                                <a
                                    href="https://goo.gl/maps/rDNREnRJj5QJP4KW9"
                                    className="tm-contact-item-link"
                                >
                            ...
                            <div className="col-sm-12 col-md-6 d-flex align-items-center tm-contact-item">
                                ...
                                <form
                                    action="https://resful.us19.list-manage.com/subscribe/post?u=31f43fe420541e025554f1b7c&amp;id=9da11a7764"
                                    method="post"
                    ...
                    <footer className="text-center small tm-footer">
                        <p className="mb-0">Copyright © 2019 Resful</p>
                    </footer>
                </section>
            </div>
        )
